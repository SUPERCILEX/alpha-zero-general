...
class GeneralsNNet(nn.Module):
    def __init__(self, game, args):
        ...
        super(GeneralsNNet, self).__init__()
        self.conv1 = nn.Conv2d(4, args.num_channels, 2, stride=1, padding=1)
    ...
    def forward(self, s):
        #                                                           s: batch_size x board_x x board_y x 5
        s = s.view(-1, 5, self.board_x, self.board_y)[:,1:,:,:]
